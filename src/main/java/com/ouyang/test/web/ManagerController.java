...
import com.ouyang.test.web.exception.ManagerDeleteException;
...
public class ManagerController {
	 ...
	 * 
	 * @param e
	 *            Thrown exception with manager that couldn"t be deleted
	 ...
	 *            Manager"s ID
	 * @param manager
	 *            Manager to update (bounded from HTML form)
