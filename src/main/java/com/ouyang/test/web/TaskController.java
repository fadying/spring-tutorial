...
import com.ouyang.test.web.exception.TaskDeleteException;
...
public class TaskController {
	...
	public void removeEmployee(@PathVariable("id") long taskId,
	...
	protected void initBinder(WebDataBinder binder) {
		binder.registerCustomEditor(Manager.class,
				new ManagerEditor(managerDao));
	}
